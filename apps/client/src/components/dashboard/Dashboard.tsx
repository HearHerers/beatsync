...
import { ListMusic, PartyPopper, Settings } from "lucide-react";
  ...
  return (
    <div className="w-full h-dvh flex flex-col text-white bg-neutral-950">
      ...
      {isReady && (
        ...
        >
          {/* --- DESKTOP LAYOUT (lg+) --- */}
          {/* Left sidebar removed (#93): room name + QR live in the top bar,
              users + settings in the right panel, upload in Main. */}
